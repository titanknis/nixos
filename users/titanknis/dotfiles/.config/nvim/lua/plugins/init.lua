...
local plugins = {
	...
	-- Tools
	-- require("plugins.tools.markview"), --NOTE: did not take close look; currently think it is too much abstraction
	-- require("plugins.tools.render-markdown"), --NOTE: did not take close look; currently think it is too much abstraction
