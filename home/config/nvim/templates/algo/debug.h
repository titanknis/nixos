...
template <typename T, size_t N> std::ostream&   operator<<(std::ostream&, const std::array<T, N>&);
template <typename T, typename U> std::ostream& operator<<(std::ostream&, const std::pair<T, U>&);
...
template <class... Args> std::ostream& operator<<(std::ostream&, const std::tuple<Args...>&);
...
template <typename T> std::ostream& operator<<(std::ostream&, const std::multiset<T>&);
template <typename T> std::ostream& operator<<(std::ostream&, const std::unordered_multiset<T>&);
template <size_t N> std::ostream&   operator<<(std::ostream&, const std::bitset<N>&);
template <typename T> std::ostream& operator<<(std::ostream&, const std::deque<T>&);
template <typename T, typename Container, typename Compare>
std::ostream& operator<<(std::ostream&, std::priority_queue<T, Container, Compare>);
template <typename T> std::ostream& operator<<(std::ostream&, std::stack<T>);
template <typename T> std::ostream& operator<<(std::ostream&, std::queue<T>);
